		...
		internal override TreeNode Derivative(int index, TreeNode arg1, TreeNode arg2){
			if (arg1.DependsOnRealVar(index)){
				return arg2.DependsOnRealVar(index)
					? Ratio(Difference(Product(arg1.Derivative(index), arg2), Product(arg1, arg2.Derivative(index))), Square(arg2))
					: Ratio(arg1.Derivative(index), arg2);
			}
			return arg2.DependsOnRealVar(index) ? Ratio(Minus(Product(arg1, arg2.Derivative(index))), Square(arg2)) : zero;
		}
