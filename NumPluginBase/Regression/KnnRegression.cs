...
namespace NumPluginBase.Regression {
	public class KnnRegression : IRegressionMethod {
		public RegressionModel Train(BaseVector[] x, double[] y, Parameters param, int ntheads) {
		...
		public Parameters Parameters => new Parameters(Distances.GetDistanceParameters(),
